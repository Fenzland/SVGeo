	...
	return [
		...
		main(
			article(
				...
				h3( 'More demos', ),
				p(
					a( 'Equilateral triangle', { href:router.linkTo( 'equilateral_triangle', ), }, ),
					', ',
					a( 'Angular bisector', { href:router.linkTo( 'angular_bisector', ), }, ),
					', ',
					a( 'Tangent line of circle', { href:router.linkTo( 'tangent_line_of_circle', ), }, ),
					', ',
				),
			),
		),
